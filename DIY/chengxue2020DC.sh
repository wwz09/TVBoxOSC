#!/bin/bash
#添加PY支持
cp -rf $GITHUB_WORKSPACE/DIY/png/图标7-1.png app/src/main/res/drawable/app_banner_b.png
cp -rf $GITHUB_WORKSPACE/DIY/png/背景2.png app/src/main/res/drawable/app_bg.png
cp -rf $GITHUB_WORKSPACE/DIY/png/图标7.png app/src/main/res/drawable-hdpi/app_icon.png
cp -rf $GITHUB_WORKSPACE/DIY/png/图标7.png app/src/main/res/drawable-xhdpi/app_icon.png
cp -rf $GITHUB_WORKSPACE/DIY/png/图标7.png app/src/main/res/drawable-xxhdpi/app_icon.png
cp -rf $GITHUB_WORKSPACE/DIY/png/图标7.png app/src/main/res/drawable-xxxhdpi/app_icon.png
...
sed -i 's%Jade%千千影视%g' app/src/main/res/values/strings.xml
