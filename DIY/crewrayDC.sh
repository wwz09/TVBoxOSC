#!/bin/bash
#添加PY支持
cp -rf $GITHUB_WORKSPACE/DIY/png/图标12-1.png app/src/main/res/drawable/app_banner.png
...
sed -i 's%tv.org.eu.bunnyabc%tv.org.eu.bunnyabc.cre%g' app/build.gradle
